      ...
      <div class="d-lg-flex align-items-center">
        ...
        <div class="ml-lg-auto mb-2 mb-lg-0">
          <div class="btn-group-round">
            <div class="btn-group">
              <button type="button"
                class="btn btn-white">Daiiy</button>
              <button type="button"
                class="btn btn-white">Weekly</button>
              <button type="button"
                class="btn btn-white">Monthly</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card radius-15 w-100">
        <div class="card-body">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress radius-15"
              style="height:4px;">
              <div class="progress-bar bg-voilet"
                role="progressbar"
                style="width: 55%">
              </div>
            </div>
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress radius-15"
              style="height:4px;">
              <div class="progress-bar bg-red-light"
                role="progressbar"
                style="width: 64%"></div>
            </div>
          </div>
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress radius-15"
              style="height:4px;">
              <div class="progress-bar bg-sunset"
                role="progressbar"
                style="width: 78%">
              </div>
            </div>
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress radius-15"
              style="height:4px;">
              <div class="progress-bar bg-wall"
                role="progressbar"
                style="width: 82%">
              </div>
            </div>
        ...
        <div class="table-responsive">
          <table class="table mb-0">
            <thead>
              <tr>
                <th scope="col"
                  class="text-blue-ribbon">Countries</th>
                <th scope="col"
                  class="text-brink-pink">Orders</th>
                <th scope="col"
                  class="text-mountain-meadow">Earnings</th>
              </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <div class="card-body">
          ...
          <div class="media align-items-center mt-3">
            ...
            <div class="media-body ml-3">
              ...
              class="btn btn-sm btn-light-primary radius-10">Add</a>
          </div>
          <hr>
          <div class="media align-items-center">
  ...
  <div class="card radius-15">
    <div class="card-header border-bottom-0">
      <div class="d-flex align-items-center">
        ...
        <div class="ml-auto">
          <button type="button"
            class="btn btn-white radius-15">View More</button>
        </div>
      </div>
    </div>
