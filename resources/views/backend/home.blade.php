    ...
    <div class="card-body">
      <div class="d-flex align-items-center">
        ...
        <div class="dropdown ml-auto">
          <div class="cursor-pointer font-24 dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown">
            <i class="bx bx-dots-horizontal-rounded"></i>
          </div>
          <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="javascript:;">Action</a>
            <a class="dropdown-item" href="javascript:;">Another action</a>
            <div class="dropdown-divider"></div> <a class="dropdown-item" href="javascript:;">Something else
              here</a>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-12 col-lg-5">
            <div class="d-flex align-items-center justify-content-between">
              <div class="text-secondary"><i class='bx bxs-circle font-13 text-primary-blue mr-2'></i>Desktop
              </div>
              <div>$850.04</div>
            ...
            <div class="my-2"></div>
            <div class="d-flex align-items-center justify-content-between">
              <div class="text-secondary"><i class='bx bxs-circle font-13 text-shineblue mr-2'></i>Mobile
              </div>
              <div>$755.08</div>
    ...
    <div class="card radius-15">
      <div class="card-header border-bottom-0">
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown ml-auto">
            <div class="cursor-pointer font-24 dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown"><i
    ...
    <div class="card radius-15">
      <div class="card-body">
        ...
        <div class="media align-items-center mt-3">
          <img src="{{ asset('assets/images/avatars/avatar-1.png') }}" width="45" height="45" class="rounded-circle"
            alt="">
        ...
        <hr>
        <div class="media align-items-center">
          <img src="{{ asset('assets/images/avatars/avatar-2.png') }}" width="45" height="45" class="rounded-circle"
            alt="">
          <div class="media-body ml-3">
        ...
        <hr>
        <div class="media align-items-center">
          <img src="{{ asset('assets/images/avatars/avatar-3.png') }}" width="45" height="45" class="rounded-circle"
            alt="">
          <div class="media-body ml-3">
        ...
        <hr>
        <div class="media align-items-center">
          <img src="{{ asset('assets/images/avatars/avatar-4.png') }}" width="45" height="45" class="rounded-circle"
            alt="">
          <div class="media-body ml-3">
