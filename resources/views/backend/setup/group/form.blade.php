...
@section('title')
  {{ isset($group->id) ? 'Update group' : 'Create group' }}
@endsection
@section('content')
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          ...
          <li class="breadcrumb-item active"
            aria-current="page">{{ isset($group->id) ? 'Update group' : 'Create group' }}</li>
        </ol>
      </nav>
    </div>
  </div>
        ...
        <div class="card radius-15 border-lg-top-info">
          <div class="card-header border-bottom-0 mb-4">
            <div class="d-flex align-items-center">
              <div>
                <h5 class="mb-lg-0">{{ isset($group->id) ? 'Update group' : 'Create group' }}</h5>
              </div>
              <div class="ml-auto">
                ...
                <a class="btn btn-primary m-1"
                  ...
                  data-toggle="tooltip"
                  title="Back to all groups &#9194;"><i class="bx bx-rewind"></i>Back</a>
              </div>
            </div>
          </div>
          <div class="card-body">
