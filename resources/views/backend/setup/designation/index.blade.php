      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ml-auto">
          ...
          <a class="btn btn-primary px-3"
            href="{{ route('setup.designation.create') }}"
            data-toggle="tooltip"
            title="Add new designation &#9989"><i class="bx bx-plus mr-1"></i>Add</a>
        </div>
      </div>
    </div>
    <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-sm btn-success"
                    href="{{ route('setup.designation.edit', $designation->id) }}"
                    data-toggle="tooltip"
                    title="Edit &#128221"><i class="fadeIn animated bx bx-edit"></i>
                  </a>
                  <form action="{{ route('setup.designation.destroy', $designation->id) }}"
