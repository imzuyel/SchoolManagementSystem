...
@section('title')
  {{ isset($subject->id) ? 'Update school subject' : 'Create school subject' }}
@endsection
@section('content')
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          ...
          <li class="breadcrumb-item active"
            aria-current="page">{{ isset($subject->id) ? 'Update school subject' : 'Create school subject' }}</li>
        </ol>
      </nav>
    </div>
  </div>
        ...
        <div class="card radius-15 border-lg-top-info">
          <div class="card-header border-bottom-0 mb-4">
            <div class="d-flex align-items-center">
              <div>
                <h5 class="mb-lg-0">{{ isset($subject->id) ? 'Update school subject' : 'Create school subject' }}</h5>
              </div>
              <div class="ml-auto">
